package eladkay.quaeritum.api.book.hierarchy.entry.criterion;

import com.google.gson.JsonObject;
import eladkay.quaeritum.api.book.hierarchy.entry.criterion.game.CriterionAdvancement;
import eladkay.quaeritum.api.book.hierarchy.entry.criterion.game.CriterionCode;
import eladkay.quaeritum.api.book.hierarchy.entry.criterion.game.CriterionEntry;
import eladkay.quaeritum.api.book.hierarchy.entry.criterion.logic.CriterionAnd;
import eladkay.quaeritum.api.book.hierarchy.entry.criterion.logic.CriterionChoose;
import eladkay.quaeritum.api.book.hierarchy.entry.criterion.logic.CriterionNot;
import eladkay.quaeritum.api.book.hierarchy.entry.criterion.logic.CriterionOr;
