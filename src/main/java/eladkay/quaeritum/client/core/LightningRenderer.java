...
public class LightningRenderer {
	...
	private static Sprite streakBase = new Sprite(new ResourceLocation(LibMisc.MOD_ID, "textures/particles/streak_base.png"));
	private static Sprite streakCorner = new Sprite(new ResourceLocation(LibMisc.MOD_ID, "textures/particles/streak_corner.png"));
	...
	public static void addLightning(Vec3d point1, Vec3d point2, long seed) {
