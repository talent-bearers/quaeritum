...
import eladkay.quaeritum.common.rituals.diagrams.PactforgerBind
...
class ItemPlacer : ItemMod(LibNames.DEV_PLACER) {
    ...
    companion object {
        ...
        fun buildChalksForPlacer(chalks: MutableList<PositionedBlock>) {
            PactforgerBind().buildChalks(chalks)
            PositionedBlockHelper.transform(chalks, EnumFacing.NORTH, -1)
        }
    }
}
