...
public class FXBeam extends Particle {
    ...
    public FXBeam(World par1World, double x, double y, double z, float red, float blue, float green, boolean longLived) {
        this(par1World, x, y, z, red, blue, green);
        this.particleMaxAge *= 5;
    }

    public FXBeam(World par1World, double x, double y, double z, float red, float blue, float green) {
